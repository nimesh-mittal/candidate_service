...
func (ctx *CandidateMongoDBContext) ListCandidates(fCtx *models.FlowCtx, limit int, offset int) (*[]models.Candidate, error) {
...
func (ctx *CandidateMongoDBContext) GetCandidate(fCtx *models.FlowCtx, cid string) (*models.Candidate, error) {
	findOptions := options.Find()
...
func (ctx *CandidateMongoDBContext) CreateCandidate(fCtx *models.FlowCtx, candidate *models.Candidate) (*models.Candidate, error) {
	collection := ctx.DB.Database(commons.CANDIDATE_DB).Collection(commons.CANDIDATE_COLL)
...
func GetBSON(entity *models.Candidate) *bson.D {
	// TODO: use reflect
...
func (ctx *CandidateMongoDBContext) UpdateCandidate(fCtx *models.FlowCtx, cid string, entity *models.Candidate) (string, error) {
	collection := ctx.DB.Database(commons.CANDIDATE_DB).Collection(commons.CANDIDATE_COLL)
...
func (ctx *CandidateMongoDBContext) DeleteCandidate(fCtx *models.FlowCtx, cid string) (*models.Candidate, error) {
	collection := ctx.DB.Database(commons.CANDIDATE_DB).Collection(commons.CANDIDATE_COLL)
