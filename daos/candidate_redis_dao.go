...
func (ctx *CandidateRedisContext) ListCandidates(limit int64, offset int64) (*[]models.Candidate, error) {
...
func (ctx *CandidateRedisContext) GetCandidate(cid string) (*models.Candidate, error) {
	conn := ctx.DB.Get()
	defer conn.Close()
...
func (ctx *CandidateRedisContext) CreateCandidate(candidate *models.Candidate) (*models.Candidate, error) {
	conn := ctx.DB.Get()
	defer conn.Close()
...
func (ctx *CandidateRedisContext) DeleteCandidate(cid string) (*models.Candidate, error) {
	conn := ctx.DB.Get()
	defer conn.Close()
